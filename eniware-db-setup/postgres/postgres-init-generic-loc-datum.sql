CREATE TABLE eniwaredatum.da_loc_datum (
...
CREATE TABLE eniwaredatum.da_loc_meta (
  loc_id bigint NOT NULL,
  source_id text NOT NULL,
...
CREATE TABLE eniwareagg.agg_stale_loc_datum (
...
CREATE TABLE eniwareagg.agg_loc_messages (
...
CREATE INDEX agg_loc_messages_ts_loc_idx ON eniwareagg.agg_loc_messages (ts, loc_id);

CREATE TABLE eniwareagg.agg_loc_datum_hourly (
  ts_start timestamp with time zone NOT NULL,
...
CREATE TABLE eniwareagg.agg_loc_datum_daily (
  ts_start timestamp with time zone NOT NULL,
...
CREATE TABLE eniwareagg.agg_loc_datum_monthly (
  ts_start timestamp with time zone NOT NULL,
  local_date date NOT NULL,
  loc_id bigint NOT NULL,
  source_id text NOT NULL,
