...
CREATE TYPE eniwarenet.instruction_delivery_state AS ENUM 
	('Unknown', 'Queued', 'Received', 'Executing', 'Declined', 'Completed');

CREATE TABLE eniwarenet.sn_Edge_instruction (
	id				BIGINT NOT NULL DEFAULT nextval('eniwarenet.instruction_seq'),
	created			TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT CURRENT_TIMESTAMP,
	Edge_id			BIGINT NOT NULL,
	topic			CHARACTER VARYING(128) NOT NULL,
	instr_date		TIMESTAMP WITH TIME ZONE NOT NULL,
	deliver_state	eniwarenet.instruction_delivery_state NOT NULL,
	jresult_params	json,
...
CREATE INDEX sn_Edge_instruction_Edge_idx ON eniwarenet.sn_Edge_instruction 
	(Edge_id, deliver_state, instr_date);

CREATE TABLE eniwarenet.sn_Edge_instruction_param (
	...
	CONSTRAINT sn_Edge_instruction_param_sn_Edge_instruction_fk
		FOREIGN KEY (instr_id) REFERENCES eniwarenet.sn_Edge_instruction (id) 
