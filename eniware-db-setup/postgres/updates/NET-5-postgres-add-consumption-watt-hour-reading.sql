ALTER TABLE eniwarenet.sn_consum_datum ADD COLUMN watt_hour bigint;

DROP FUNCTION eniwarenet.calc_avg_watt_hours(real, real, real, real, real, real, interval);

CREATE OR REPLACE FUNCTION eniwarenet.calc_avg_watt_hours(
