ALTER TABLE solarnet.sn_consum_datum DROP CONSTRAINT IF EXISTS consum_datum_Edge_unq;
ALTER TABLE solarnet.sn_consum_datum
  ADD CONSTRAINT consum_datum_Edge_unq UNIQUE(Edge_id, created, source_id)
  DEFERRABLE INITIALLY IMMEDIATE;
DROP INDEX IF EXISTS solarnet.consum_datum_Edge_idx;
...
ALTER TABLE solarnet.sn_hardware_control_datum DROP CONSTRAINT IF EXISTS sn_hardware_control_datum_Edge_unq;
ALTER TABLE solarnet.sn_hardware_control_datum
  ...
  DEFERRABLE INITIALLY IMMEDIATE;
DROP INDEX IF EXISTS solarnet.sn_hardware_control_datum_Edge_idx;

ALTER TABLE solarnet.sn_power_datum DROP CONSTRAINT IF EXISTS power_datum_Edge_unq;
ALTER TABLE solarnet.sn_power_datum
  ADD CONSTRAINT power_datum_Edge_unq UNIQUE(Edge_id, created, source_id)
  DEFERRABLE INITIALLY IMMEDIATE;
DROP INDEX IF EXISTS solarnet.power_datum_Edge_idx;
...
DROP INDEX solarrep.rep_consum_datum_daily_Edge_idx;
...
DROP INDEX solarrep.rep_consum_datum_hourly_Edge_idx;
...
DROP INDEX solarrep.rep_power_datum_daily_Edge_idx;
...
DROP INDEX solarrep.rep_power_datum_hourly_Edge_idx;
...
DROP INDEX solarrep.rep_price_datum_daily_Edge_idx;
...
DROP INDEX solarrep.rep_price_datum_hourly_Edge_idx;

CLUSTER solarnet.sn_consum_datum USING consum_datum_Edge_unq;
CLUSTER solarnet.sn_day_datum USING sn_day_datum_loc_unq;
CLUSTER solarnet.sn_hardware_control_datum USING sn_hardware_control_datum_Edge_unq;
CLUSTER solarnet.sn_power_datum USING power_datum_Edge_unq;
