...
ALTER TABLE solaruser.user_Edge_conf ADD COLUMN sec_phrase CHARACTER VARYING(128);
UPDATE solaruser.user_Edge_conf SET sec_phrase = 'changeit';
ALTER TABLE solaruser.user_Edge_conf ALTER COLUMN sec_phrase SET NOT NULL;

ALTER TABLE solaruser.user_Edge_conf
