-- eniwaredatum location datum functions that rely on other namespaces like eniwareagg

/**
 * Add or update a location datum record. The data is stored in the <code>eniwaredatum.da_loc_datum</code> table.
 *
...
BEGIN
	INSERT INTO eniwaredatum.da_loc_datum(ts, loc_id, source_id, posted, jdata_i, jdata_a, jdata_s, jdata_t)
	VALUES (ts_crea, loc, src, ts_post, jdata_json->'i', jdata_json->'a', jdata_json->'s', eniwarecommon.json_array_to_text_array(jdata_json->'t'))
