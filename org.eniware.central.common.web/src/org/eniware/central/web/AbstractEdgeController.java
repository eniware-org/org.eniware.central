...
/**
 * Abstract base class to support Edge-related controllers.

 * @version 1.1
 */
public abstract class AbstractEdgeController {
	 ...
	 * {@code dateFormat} and {@code Edge} property which, if provided, will add
	 * a {@link JodaDateFormatEditor} to the registrar for all {@link DateTime}
	 * objects, configured with the Edge's time zone.
	 * </p>
	 * 
	 * @param request
	 *        the HTTP request
	 ...
	 * @param Edge
	 *        an optional Edge (required if {@code dateFormat} provided)
	 * @return the registrar
	 */
	protected CloningPropertyEditorRegistrar setupViewPropertyEditorRegistrar(
			HttpServletRequest request, String dateFormat, EniwareEdge Edge) {
		return setupViewPropertyEditorRegistrar(request, dateFormat,
				(Edge == null ? null : Edge.getTimeZone()));
	}
