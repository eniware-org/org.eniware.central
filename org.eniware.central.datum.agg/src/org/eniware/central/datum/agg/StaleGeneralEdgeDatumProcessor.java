...
/**
 * Job to process "stale" general Edge datum reporting aggregate data.
 * 
 ...
 * @version 1.1
 */
public class StaleGeneralEdgeDatumProcessor extends StaleDatumProcessor {
	 ...
	 */
	public StaleGeneralEdgeDatumProcessor(EventAdmin eventAdmin, JdbcOperations jdbcOps) {
